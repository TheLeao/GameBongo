...
type Argument struct {
	...
	IsMemory bool
	DataType int
	readFn   func(*Registers, core.AddressSpace, []int) int
	writeFn  func(*Registers, core.AddressSpace, []int, int)
}
...
func NewArgument(label string, oprndLen int, isMemory bool, dataType int) Argument {
	...
	switch label {
	case "A":
		a.readFn = func(r *Registers, a core.AddressSpace, args []int) int {
			return r.A
		}
		a.writeFn = func(r *Registers, a core.AddressSpace, args []int, c int) {
			r.A = c
		}
	case "B":
		a.readFn = func(r *Registers, a core.AddressSpace, args []int) int {
...
func (a *Argument) Read(reg *Registers, addr core.AddressSpace, args []int) int {
	return a.readFn(reg, addr, args)
}

func (a *Argument) Write(reg *Registers, addr core.AddressSpace, args []int, cntxt int) {
